...
The code needed to reproduce the results of these two papers and to apply the proposed methodology can be found in my [Git repository](https://github.com/Sebastian-Jensen/Neural-Networks-for-Panel-Data).
